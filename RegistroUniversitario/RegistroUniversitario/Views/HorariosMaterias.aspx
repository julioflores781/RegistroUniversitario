<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HorariosMaterias.aspx.cs" Inherits="RegistroUniversitario.Views.HorariosMaterias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        $(() => {
            ...
            const URL = '/api/HorariosMaterias';

            const srv_HorariosMaterias = new DevExpress.data.CustomStore({
                key: 'id',
                load() {
                ...
                editing: {
                    ...
                    form: {
                        items: [{
                            ...
                            colCount: 2,
                            colSpan: 2,
                            items: ['id_materia', 'hora_inicio', 'hora_finalizacion', 'aula', 'Lunes', 'martes', 'miercoles', 'jueves', 'viernes']
                        }],
                    },
                },
                columns: [
