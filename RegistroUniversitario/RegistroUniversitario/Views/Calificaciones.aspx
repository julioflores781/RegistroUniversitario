<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Calificaciones.aspx.cs" Inherits="RegistroUniversitario.Views.Calificaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        $(() => {
            ...
            const URL = '/api/Calificaciones';

            const srv_calificaciones = new DevExpress.data.CustomStore({
                key: 'id',
                load() {
                ...
                editing: {
                    ...
                    form: {
                        items: [{
                            ...
                            colCount: 2,
                            colSpan: 2,
                            items: ['id_estudiante', 'id_materia', 'puntuacion', 'fecha_calificacion']
                        }],
                    },
                },
                columns: [
